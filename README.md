...
Requesting Feature Reviews will begin on Wednesday of the third week of capstone development (W43D3) and go through until the end of Tuesday (W44D2). Ideally, your project should be nearly completed before submitting a feature review so we can point out as many bugs/corrections that will help prepare you for the final grading when projects are due. You can reach out to your project manager when your project is ready for a feature review.
...
*The last time to deploy any changes to your Render application will be at 12 AM PT / 3 AM EST on Friday of Week 44. Any changes made during final grading will be **considered cheating and handled appropriately**.*
